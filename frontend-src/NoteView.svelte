...
{:then entry}
  ...
  <div class="uk-margin-bottom">
    {#if entry.isArchived}
      <button on:click={doDelete} class="uk-button uk-button-default">
        <i class="fas fa-trash" />&nbsp;Удалить
      </button>

      <button on:click={doUnarchive} class="uk-button uk-button-default">
        <i class="fas fa-archive" />&nbsp;Восстановить
      </button>
    {:else}
    ...
    <!-- <a href={notePdfUrl(entry.id)} download class="uk-button uk-button-secondary">
